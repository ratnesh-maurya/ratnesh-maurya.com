...
export const seoConfig = {
  ...
  pages: {
    ...
    projects: {
      title: "Software Projects - Ratnesh Maurya | MDConverter, JSONic & More",
      description: "Discover innovative software projects by Ratnesh Maurya including MDConverter for markdown conversion, JSONic for JSON editing, and other web applications, CLI tools, and open-source contributions.",
      priority: 0.9,
      changeFrequency: "weekly" as const,
    },
    gallery: {
